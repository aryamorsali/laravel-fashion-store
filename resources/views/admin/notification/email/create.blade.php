...
@section('head-tag')
    <title>Create Email notification</title>
    ...
    <section class="container-fluid px-0">
        <nav style="background-color: #eee; height: 2.25rem" class="my-4 rounded ps-2" aria-label="breadcrumb">
            <ol class="breadcrumb p-1 ">
                ...
                <li class="breadcrumb-item active">Create Email notification</li>
            </ol>
        </nav>
        <section class="main-body-container">
            <section>
                <h3 class="mt-2">Create Email notification</h3>
            </section>
                    ...
                    <section class="row">
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="subject" id="subject" placeholder="optional"
                                    value="{{ old('subject') }}">
                            </div>
                            @error('subject')
