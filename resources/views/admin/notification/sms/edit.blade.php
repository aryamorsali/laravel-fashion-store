...
@section('content')
    <section class="container-fluid px-0">
        ...
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.notification.sms.update' , $sms) }}" method="post" id="form">
                    @csrf
                    @method('put')
                    <section class="row">
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="title" id="title"
                                    placeholder="optional" value="{{ old('title' , $sms->title) }}">
                            </div>
                            @error('title')
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="published_at" id="published_at"
                                    class="form-control form-control-sm" value="{{ old('published_at' , $sms->published_at) }}"
                        ...
                        <section class="col-12 my-3">
                            <div class="form-group">
                                ...
                                <textarea name="body" class="form-control form-control-sm" id="body" rows="6">{{ old('body' , $sms->body) }}</textarea>
                            </div>
                            @error('body')
                                <div class="text-danger" style="margin-top: 9px; font-size: 12px; font-weight: 400;">
                                    <strong>{{ $message }}</strong>
