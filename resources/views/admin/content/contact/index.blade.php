...
@section('content')
    <section class="container-fluid px-0">
        ...
        <section class="main-body-container">
            <section>
                <h3 class="mt-2 mb-4">Contact Messages</h3>
            </section>
                            ...
                            <tr>
                                ...
                                @can('view-contact-message')
                                    <td class="width-16-rem text-center">
                                        <a href="{{ route('admin.content.contact.show', $contactMessage) }}"
                                            class="btn btn-primary btn-sm width-6-rem mi"><i class="fa fa-eye"></i>
                                            Show</a>
                                    </td>
                                @endcan
                            </tr>
