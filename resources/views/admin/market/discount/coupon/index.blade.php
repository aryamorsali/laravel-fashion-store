        ...
        <section class="main-body-container">
            ...
            <section class="d-flex align-items-center mt-4 mb-3 border-bottom pb-2">
                <div class="me-auto" style="max-width: 16rem;">
                    {{-- // search --}}
                    <form class="d-flex align-items-center" action="{{ route('admin.market.discount.coupon') }}"
                        method="GET">

                        <input type="text" name="search" value="{{ request('search') }}"
                            class="form-control form-control-sm" style="margin-right: 5px" placeholder="search (code)">
            ...
            <section class="table-responsive">
                ...
                <div class="d-flex justify-content-center mt-4">
                    {{ $coupons->onEachSide(1)->links('vendor.pagination.custom') }}
                </div>
            </section>
        </section>
