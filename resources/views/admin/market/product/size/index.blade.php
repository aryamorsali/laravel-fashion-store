        ...
        <section class="main-body-container">
            ...
            <section class="d-flex align-items-center mt-4 mb-3 border-bottom pb-2">
                <div class="me-auto" style="max-width: 16rem;">
                    {{-- // search --}}
                    <form class="d-flex align-items-center" action="{{ route('admin.market.size.index') }}"
                        method="GET">
            ...
            <section class="table-responsive">
                            ...
                            <tr>
                                ...
                                @can('delete-size')
                                    <td class="width-16-rem text-center">
                                        <form class="d-inline" action="{{ route('admin.market.size.destroy', $size) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
                ...
                <div class="d-flex justify-content-center mt-4">
                    {{ $sizes->onEachSide(1)->links('vendor.pagination.custom') }}
                </div>
            </section>
        </section>
