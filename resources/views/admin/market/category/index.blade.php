        ...
        <section class="main-body-container">
            ...
            <section class="d-flex align-items-center mt-4 mb-3 border-bottom pb-2">
                <div class="me-auto" style="max-width: 16rem;">
                    {{-- // search --}}
                    <form class="d-flex align-items-center" action="{{ route('admin.market.category.index') }}"
                        method="GET">
            ...
            <section class="table-responsive">
                                ...
                                <td>
                                    <label>
                                        <input id="{{ $productCategory->id }}"
                                            @cannot('update-product-category') disabled @endcannot
                ...
                <div class="d-flex justify-content-center mt-4">
                    {{ $productCategories->onEachSide(1)->links('vendor.pagination.custom') }}
                </div>
            </section>
        </section>
