    ...
    <section class="container-fluid px-0">
        <nav style="background-color: #eee; height: 2.25rem" class="my-4 rounded ps-2" aria-label="breadcrumb">
            <ol class="breadcrumb p-1 ">
                ...
                <li class="breadcrumb-item active">Edit HomeBox</li>
            </ol>
        </nav>
        <section class="main-body-container">
            <section>
                <h3 class="mt-2">Edit HomeBox</h3>
            </section>
            ...
            <section>
                <form action="{{ route('admin.market.home-box.update', $homeBox) }}" method="post"
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="subtitle" id="subtitle"
                                    placeholder="optional" value="{{ old('subtitle', $homeBox->subtitle) }}">
                            </div>
                            @error('subtitle')
                                <div class="text-danger" style="margin-top: 9px; font-size: 12px; font-weight: 400;">
                                    <strong>{{ $message }}</strong>
                                ...
                                <select name="category_id" class="form-control form-control-sm" id="category_id">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            @if (old('category_id', $homeBox->category_id) == $category->id) selected @endif>
                        ...
                        <section class="col-12 col-md-6 my-3">
                            ...
                            @if ($homeBox->image)
                                <div class="mt-3">
                                    <img class="rounded" src="{{ asset($homeBox->image) }}" alt=""
